...
namespace CoursesLibrary.DbContexts
{
  public class CoursesLibraryContext : DbContext
  {
    public CoursesLibraryContext(DbContextOptions<CoursesLibraryContext> options)
       : base(options)
    {
    }
