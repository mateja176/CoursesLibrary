...
{
  [DbContext(typeof(CoursesLibraryContext))]
  partial class CoursesLibraryContextModelSnapshot : ModelSnapshot
  {
...
#pragma warning disable 612, 618
      ...
      modelBuilder.Entity("CoursesLibrary.API.Entities.Author", b =>
          {
            b.Property<Guid>("Id")
                      .ValueGeneratedOnAdd()
            ...
            b.HasData(
                      new
                  {
                    ...
                    DateOfBirth = new DateTimeOffset(new DateTime(1650, 7, 23, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 54, 0, 0)),
                    FirstName = "Berry",
                      ...
                      new
                  {
                    ...
                    DateOfBirth = new DateTimeOffset(new DateTime(1668, 5, 21, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 54, 0, 0)),
                    FirstName = "Nancy",
                      ...
                      new
                  {
                    ...
                    DateOfBirth = new DateTimeOffset(new DateTime(1701, 12, 16, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 54, 0, 0)),
                    FirstName = "Eli",
                      ...
                      new
                  {
                    ...
                    DateOfBirth = new DateTimeOffset(new DateTime(1702, 3, 6, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 54, 0, 0)),
                    FirstName = "Arnold",
                      ...
                      new
                  {
                    ...
                    DateOfBirth = new DateTimeOffset(new DateTime(1690, 11, 23, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 54, 0, 0)),
                    FirstName = "Seabury",
                      ...
                      new
                  {
                    ...
                    DateOfBirth = new DateTimeOffset(new DateTime(1723, 4, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 54, 0, 0)),
                      ...
                      new
                  {
                    ...
                    DateOfBirth = new DateTimeOffset(new DateTime(1721, 10, 11, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 54, 0, 0)),
                    FirstName = "Atherton",
      ...
      modelBuilder.Entity("CoursesLibrary.API.Entities.Course", b =>
          {
            b.Property<Guid>("Id")
                      .ValueGeneratedOnAdd()
                      .HasColumnType("uniqueidentifier");
      ...
      modelBuilder.Entity("CoursesLibrary.API.Entities.Course", b =>
          {
            b.HasOne("CoursesLibrary.API.Entities.Author", "Author")
                      .WithMany("Courses")
